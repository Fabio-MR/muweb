...
-->
						<h2><i class="icons icon-signin"></i>Login</h2>
						...
						<div class="main">
							<form method="post" action="post/signin">
								...
								<label><i>Usuario:</i><input class="text-box" name="login" placeholder="Enter login" type="text"></label>
								<label><i>Senha:</i><input class="text-box" name="password" placeholder="Enter password" type="password"></label>
								...
								<div class="center">
									<a href="signup"><i>Criar uma conta</i></a> &nbsp;&nbsp;&nbsp;
									<a href="forgot"><i>Esqueceu a senha?</i></a>
								</div>
