...
DEFINE("LDPU_LOG_TXT_MODIFY_DATA"../pt-br - Cópia/, "Usado o serviço de alterar dados da conta.");
DEFINE("LDPU_LOG_TXT_CLEAN_VAULT"../pt-br - Cópia/, "Usado o serviço de limpar bau.");
DEFINE("LDPU_LOG_TXT_DOUBLE_VAULT"../pt-br - Cópia/, "Usado o serviço de alternar bau.");
DEFINE("LDPU_LOG_TXT_MODIFY_PERSONALID"../pt-br - Cópia/, "Usado o serviço de alterar personal id.");
DEFINE("LDPU_LOG_TXT_RESET"../pt-br - Cópia/, "Usado o serviço de resetar personagem.");
DEFINE("LDPU_LOG_TXT_MASTER_RESET"../pt-br - Cópia/, "Usado o serviço de master reset.");
DEFINE("LDPU_LOG_TXT_RESET_TRANSFER"../pt-br - Cópia/, "Usado o serviço de transferir resets.");
DEFINE("LDPU_LOG_TXT_CLEAN_PK"../pt-br - Cópia/, "Usado o serviço de limpar pk.");
DEFINE("LDPU_LOG_TXT_DISTRIBUTE_POINTS"../pt-br - Cópia/, "Usado o serviço de distribuir pontos.");
DEFINE("LDPU_LOG_TXT_MOVE_CHARACTER"../pt-br - Cópia/, "Usado o serviço de mover personagem.");
DEFINE("LDPU_LOG_TXT_CHANGE_NICK"../pt-br - Cópia/, "Usado o serviço de alterar nick.");
DEFINE("LDPU_LOG_TXT_CHANGE_CLASS"../pt-br - Cópia/, "Usado o serviço de alterar classe.");
DEFINE("LDPU_LOG_TXT_REDISTRIBUTE_POINTS"../pt-br - Cópia/, "Usado o serviço de redistribuir pontos.");
DEFINE("LDPU_LOG_TXT_CLEAN_INVENTORY"../pt-br - Cópia/, "Usado o serviço de limpar invetário.");
DEFINE("LDPU_LOG_TXT_SEND_SMS"../pt-br - Cópia/, "Usado o serviço de envio de sms.");
DEFINE("LDPU_LOG_TXT_GAME_DISCONNECT"../pt-br - Cópia/, "Usado o serviço de desconectar conta.");
DEFINE("LDPU_LOG_TXT_TRANSFER_CASH"../pt-br - Cópia/, "Usado o serviço de transferir cash.");
DEFINE("LDPU_LOG_TXT_COLLECTOR_POINTS"../pt-br - Cópia/, "Usado o serviço de coletar pontos.");
DEFINE("LDPU_LOG_TXT_NOT_FOUND"../pt-br - Cópia/, "O Serviço de tipo %d não foi cadastrado para logs."); 
                                                                        
DEFINE("LDPU_DEMO_OPTION_NON_AVAILABLE"../pt-br - Cópia/, "Opção não disponivel usando uma licença de demonstração.");  
DEFINE("LDPU_YOU_MUST_BE_OFFLINE"../pt-br - Cópia/, "Voc&ecirc; deve estar offline no jogo."); 
DEFINE("LDPU_THIS_CHARACTER_NOT_EXIST"../pt-br - Cópia/, "Erro: Esse personagem não existe ou não pertence ao seu login."); 
DEFINE("LDPU_YES"../pt-br - Cópia/, "Sim"); 
DEFINE("LDPU_NOT"../pt-br - Cópia/, "N&atilde;o"); 

DEFINE("LDPU_OPTIONS_DEFAULT_BANNED_ACCOUNT"../pt-br - Cópia/, "<strong><em>Sua conta está banida até:</em> %s.</strong><br />Para desbanir sua conta acesse seu painel de controle após a data especificada acima."); 
DEFINE("LDPU_OPTIONS_DEFAULT_NOT_ACTIVE_ACCOUNT"../pt-br - Cópia/, "<strong>Sua conta ainda não foi ativada!</strong><br />Você só conseguirá entrar no jogo após a ativação da mesma.<br />Para ativar, veja as instruções enviadas ao seu e-mail.<br /><br />Caso o e-mail de ativação não tenha chegado na sua caixa de e-mails, <a href='?page=register&resendActivateEmail=%s'>clique aqui</a> para enviar-lo novamente."); 
DEFINE("LDPU_OPTIONS_DEFAULT_FLAT_EXPIRE"../pt-br - Cópia/, "Vencimento"); 
DEFINE("LDPU_OPTIONS_DEFAULT_FLAT_ERROR"../pt-br - Cópia/, "Erro ao definir status da conta."); 
DEFINE("LDPU_OPTIONS_DEFAULT_LAST_CONNECTION"../pt-br - Cópia/, "na sala"); 
DEFINE("LDPU_OPTIONS_DEFAULT_YOU_NOT_HAVE_CHARACTERS"../pt-br - Cópia/, "Você não possui personagens"); 
DEFINE("LDPU_OPTIONS_DEFAULT_BANNED_CHARACTER"../pt-br - Cópia/, "<strong><em>Personagem %s banido até:</em> %s</strong><br />Para desbanir seu personagem acesse seu painel de controle após a data especificada acima."); 


DEFINE("LDPU_MODIFY_DATA_FILL_NAME"../pt-br - Cópia/, "O campo <strong>Meu nome</strong> deve ser preenchido."); 
DEFINE("LDPU_MODIFY_DATA_INVALID_SIZE_NAME"../pt-br - Cópia/, "O campo <strong>Meu nome</strong> não deve ter mais que 10 caracters.");      
DEFINE("LDPU_MODIFY_DATA_FILL_PHONE"../pt-br - Cópia/, "O campo <strong>Meu telefone</strong> deve ser preenchido.");                   
DEFINE("LDPU_MODIFY_DATA_INVALID_SIZE_PHONE"../pt-br - Cópia/, "O campo <strong>Meu telefone</strong> não deve ter mais que 15 caracters."); 
DEFINE("LDPU_MODIFY_DATA_SUCCESS_ALTER"../pt-br - Cópia/, "Os dados foram alterados com sucesso."); 
DEFINE("LDPU_MODIFY_DATA_ERROR_ALTER"../pt-br - Cópia/, "Erro ao alterar dados."); 

DEFINE("LDPU_MODIFY_DATA_FILL_PASSWORD"../pt-br - Cópia/, "O campo <strong>Senha atual</strong> deve ser preenchido."); 
DEFINE("LDPU_MODIFY_DATA_FILL_NEW_PASSWORD"../pt-br - Cópia/, "Os campos <strong>Nova senha</strong> devem ser preenchidos."); 
DEFINE("LDPU_MODIFY_DATA_FILL_SECRET_ANSWER"../pt-br - Cópia/, "O campo <strong>Resposta secreta</strong> deve ser preenchido."); 
DEFINE("LDPU_MODIFY_DATA_INVALID_SIZE_PASSWORD"../pt-br - Cópia/, "Os campos <strong>Nova senha</strong> não devem ter mais que 10 caracters."); 
DEFINE("LDPU_MODIFY_DATA_PASSWORDS_MUST_BE_IDENTICAL"../pt-br - Cópia/, "Os campos <strong>Senha atual</strong> devem ser preenchidos com os valores iguais."); 
DEFINE("LDPU_MODIFY_DATA_INVALID_SECRET_ANSWER"../pt-br - Cópia/, "A <strong>resposta secreta</strong> informada não é válida."); 
DEFINE("LDPU_MODIFY_DATA_INVALID_PASSWORD"../pt-br - Cópia/, "A <strong>senha atual</strong> informada não é válida.");
DEFINE("LDPU_MODIFY_DATA_LOG_PASSWORD_ALTER"../pt-br - Cópia/, "Alterado a senha");  

DEFINE("LDPU_CLEAN_VAULT_NOT_HAVE_VAULT"../pt-br - Cópia/, "Essa conta não possui bau");  
DEFINE("LDPU_CLEAN_VAULT_FILL_PASSWORD"../pt-br - Cópia/, "O campo <strong>Minha senha</strong> deve ser preenchido.");  
DEFINE("LDPU_CLEAN_VAULT_CHOOSE_TASK"../pt-br - Cópia/, "Selecione alguma tarefa a ser realizada.");  
DEFINE("LDPU_CLEAN_VAULT_INVALID_PASSWORD"../pt-br - Cópia/, "A <strong>senha</strong> informada não é válida.");  
DEFINE("LDPU_CLEAN_VAULT_1_LOG_SUCCESS"../pt-br - Cópia/, "Limpeza do bau 1 efetuada com sucesso!");  
DEFINE("LDPU_CLEAN_VAULT_1_TEXT_SUCCESS"../pt-br - Cópia/, "Sucesso: <em><strong>Bau 1 Limpo</strong></em>");    
DEFINE("LDPU_CLEAN_VAULT_2_LOG_SUCCESS"../pt-br - Cópia/, "Limpeza do bau 2 efetuada com sucesso!");  
DEFINE("LDPU_CLEAN_VAULT_2_TEXT_SUCCESS"../pt-br - Cópia/, "Sucesso: <em><strong>Bau 2 Limpo</strong></em>");  
DEFINE("LDPU_CLEAN_VAULT_ZEN_LOG_SUCCESS"../pt-br - Cópia/, "Limpeza do zen no bau!");  
DEFINE("LDPU_CLEAN_VAULT_ZEN_TEXT_SUCCESS"../pt-br - Cópia/, "Sucesso: <em><strong>Zen Limpo</strong></em>"); 

 
DEFINE("LDPU_VIRTUAL_VAULT_CANT_LOAD_DB"../pt-br - Cópia/, "O banco de dados não pode ser carregado.");  
DEFINE("LDPU_VIRTUAL_VAULT_ITEM_NOT_FOUND"../pt-br - Cópia/, "Esse item n&atilde;o existe no ba&uacute;.");  
DEFINE("LDPU_VIRTUAL_VAULT_TEXT_ITEM"../pt-br - Cópia/, "Item");  
DEFINE("LDPU_VIRTUAL_VAULT_TEXT_LEVEL"../pt-br - Cópia/, "Level");  
DEFINE("LDPU_VIRTUAL_VAULT_TEXT_OPTION"../pt-br - Cópia/, "Adicionais");  
DEFINE("LDPU_VIRTUAL_VAULT_TEXT_LUCK"../pt-br - Cópia/, "Luck");  
DEFINE("LDPU_VIRTUAL_VAULT_TEXT_SKILL"../pt-br - Cópia/, "Skill");  
DEFINE("LDPU_VIRTUAL_VAULT_TEXT_ANCIENT"../pt-br - Cópia/, "Ancient");  
DEFINE("LDPU_VIRTUAL_VAULT_TEXT_DURABILITY"../pt-br - Cópia/, "Durabilidade");  
DEFINE("LDPU_VIRTUAL_VAULT_TEXT_SERIAL"../pt-br - Cópia/, "Serial");  
DEFINE("LDPU_VIRTUAL_VAULT_TEXT_EXCELLENT"../pt-br - Cópia/, "Op&ccedil;&otilde;es excelentes");  
DEFINE("LDPU_VIRTUAL_VAULT_TEXT_REFINE"../pt-br - Cópia/, "Refine option");  
DEFINE("LDPU_VIRTUAL_VAULT_TEXT_HARMONY"../pt-br - Cópia/, "Harmony option");  
DEFINE("LDPU_VIRTUAL_VAULT_TEXT_SOCKET"../pt-br - Cópia/, "Socket option");  
DEFINE("LDPU_VIRTUAL_VAULT_TEXT_SOCKET_NAME"../pt-br - Cópia/, "Socket");  
DEFINE("LDPU_VIRTUAL_VAULT_TEXT_SEND_TO_VAULT_VIRTUAL"../pt-br - Cópia/, "Enviar para o ba&uacute; virtual");  
